        ...
        <nav class="navbar navbar-inverse navbar-siad">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"><b><h2>DPM-PTSP SURABAYA</h2></b></a>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div style="margin-top: 140px;">
                            <h1>ARSIP DIGITAL DPM-PTSP SURABAYA</h1>
