                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="breadcome-heading">
                                <h4 style="margin-bottom: 0px">Data Arsip Pusat</h4>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    ...
                    while($p = mysqli_fetch_array($arsip)){
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <b>Jenis Perizinan</b> : <?php echo $p['arsip_izin'] ?><br>
                                <b>Alamat</b> : <?php echo $p['arsip_alamat'] ?><br>
                                <b>Nama Pengusaha / Badan Usaha</b> : <?php echo $p['arsip_pengusaha'] ?><br>
                                <b>No SK</b> : <?php echo $p['arsip_sk'] ?><br> 
                                <b>Filing Cabinet / Lemari Arsip</b> : <?php echo $p['arsip_lemari'] ?><br> 
                                <b>Box</b> : <?php echo $p['arsip_box'] ?><br>
                            ...
                            <td class="text-center">
                                ...
                                <div class="btn-group">
                                    <?php if (!empty($p['arsip_jenis'])): ?>
                                        <a target="_blank" class="btn btn-default" href="arsip_download.php?id=<?php echo $p['arsip_id']; ?>">
                                            <i class="fa fa-download"></i>
                                        </a>
                                    <?php endif; ?>
                                    <a target="_blank" href="arsip_preview.php?id=<?php echo $p['arsip_id']; ?>" class="btn btn-default">
