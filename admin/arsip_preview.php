                            ...
                            <div class="col-lg-4">
                                ...
                                <table class="table">
                                    <tr>
                                        ...
                                        <td><?php echo $d['arsip_izin']; ?></td>
                                    </tr>
                                    <tr>
                                        <th>Alamat</th>
                                        <td><?php echo $d['arsip_alamat']; ?></td>
                                    </tr>
                                    <tr>
                                        <th>Nama Pengusaha / Badan Usaha</th>
                                        <td><?php echo $d['arsip_pengusaha']; ?></td>
                                    </tr>
                                    <tr>
                                        <th>No SK</th>
                                        <td><?php echo $d['arsip_sk']; ?></td>
                                    </tr>
                                    <tr>
                                        <th>Filing Cabinet / Lemari Arsip</th>
                                        <td><?php echo $d['arsip_lemari']; ?></td>
                                    </tr>
                                    <tr>
                                        <th>Box</th>
                                        <td><?php echo $d['arsip_box']; ?></td>
                                    </tr>
                                    <tr>
                                        <th>Waktu Upload</th>
