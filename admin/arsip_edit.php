                ...
                <div class="panel-body">
                    ...
                    while($d = mysqli_fetch_array($data)){
                        ...
                        <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="izin" required="required" value="<?php echo $d['arsip_izin']; ?>">
                            </div>

                            <div class="form-group">
                                <label>Alamat Persil</label>
                                <input type="text" class="form-control" name="alamat" required="required" value="<?php echo $d['arsip_alamat']; ?>">
                            </div>

                            <div class="form-group">
                                <label>Nama Pengusaha / Badan Usaha</label>
                                <input type="text" class="form-control" name="pengusaha" required="required" value="<?php echo $d['arsip_pengusaha']; ?>">
                            </div>

                            <div class="form-group">
                                <label>No SK</label>
                                <input type="text" class="form-control" name="sk" required="required" value="<?php echo $d['arsip_sk']; ?>">
                            </div>

                            <div class="form-group"
                                <label>Filing Cabinet / Lemari Arsip</label>
                                <input type="text" class="form-control" name="lemari" required="required" value="<?php echo $d['arsip_lemari']; ?>">
                            </div>

                            <div class="form-group">
                                <label>Box</label>
                                <input type="text" class="form-control" name="box" required="required" value="<?php echo $d['arsip_box']; ?>">
                            </div>
